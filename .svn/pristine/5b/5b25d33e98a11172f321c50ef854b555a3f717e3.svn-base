   ...
   //标签抵消
    ...
    private void initResourcesIfNecessary() {
        if (itemsPaint == null) {
            ...
            itemsPaint.setTextSize(context.getResources().getDimension(R.dimen.unselect_text_size));
        ...
        if (valuePaint == null) {
            ...
            valuePaint.setTextSize(context.getResources().getDimension(R.dimen.unselect_text_size));
