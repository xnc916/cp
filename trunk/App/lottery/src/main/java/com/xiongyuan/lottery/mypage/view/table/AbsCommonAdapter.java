...
import com.xiongyuan.lottery.EasyShopApplication;
...
public abstract class AbsCommonAdapter<T> extends BaseAdapter {
    ...
    protected EasyShopApplication app;

    public AbsCommonAdapter(Context context, int itemLayoutId, EasyShopApplication app) {
