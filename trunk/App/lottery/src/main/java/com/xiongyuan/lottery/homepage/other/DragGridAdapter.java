package com.xiongyuan.lottery.homepage.other;
...
import com.xiongyuan.lottery.homepage.view.CustomBehindView;
...
public class DragGridAdapter extends BaseAdapter{
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if(modifyPosition==position){
			...
			viewHold.llContainer.setBackgroundColor(mContext.getResources().getColor(R.color.colorWhite));
