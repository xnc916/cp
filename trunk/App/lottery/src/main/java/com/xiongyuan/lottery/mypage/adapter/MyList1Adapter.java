...
public class MyList1Adapter extends BaseAdapter {
    private int[] imagesIds = new int[]{R.mipmap.shengying, R.mipmap.yaoyiyao};
    private String[] itemNames = new String[]{"选号时震动", "摇一摇设置"};
    private Context context;

    public MyList1Adapter(Context context) {
