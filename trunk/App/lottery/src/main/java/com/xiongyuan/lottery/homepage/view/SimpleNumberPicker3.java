...
//投注倍数选择器
public class SimpleNumberPicker3 extends RelativeLayout {
    ...
    // 代码中使用：new
    public SimpleNumberPicker3(Context context) {
        super(context);
        init(context,null);
    }

    // 布局中使用
    public SimpleNumberPicker3(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context,attrs);
    }

    // 布局中使用，设置了style
    public SimpleNumberPicker3(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void init(Context context,AttributeSet attrs) {
        LayoutInflater.from(context).inflate(R.layout.widget_simple_number_picker3, this, true);
